...
Adapted in July 2007 by T. Liadal
Home page can be found at http://web.media.mit.edu/~benres/simpleserial/.
*/
  ...
  public void _initPort(int comPort, int baud, int dataBits, int stopBits, int parity) {
      ...
      if (cp instanceof SerialPort) {
          ...
          try {
              ...
              m_SerialPort.setSerialPortParams(baud, dataBits, 1, parity);
              //m_SerialPort.setFlowControlMode(SerialPort.FLOWCONTROL_NONE);
              m_SerialPort.setFlowControlMode(SerialPort.FLOWCONTROL_RTSCTS_IN|SerialPort.FLOWCONTROL_RTSCTS_OUT);
          }
